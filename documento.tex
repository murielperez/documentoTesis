...
\begin{table}
  \centering
  \caption{Conjunto de datos utilizados (faltan las citas de los catálogos). BG hace referencia al Bulbo Galáctico; PNM, a la Pequeña Nube de Magallanes; y GNM, a la Gran Nube de Magallanes. }
...
Cada curva de luz está guarada en un archivo que contiene tres columnas con los valores de magnitud, fecha juliana en la que fue tomada cada medida y error en la medida de la magnitud. El número de medidas para cada objeto y la separación temporal varía ampliamente. La separación mínima dos mediciones en toda la muestra es de 0.00147d, la máxima es 2156.9d y en promedio están separadas por 5.1d; por su parte el número promedio de observaciones por objeto es 759; el máximo, 5173; y el mínimo,  11 y el 75\% de los objetos cuenta con más de 386 observaciones. Para todos los objetos estas observaciones están repartidas en los (número de años) años en que estuvo activa la tercera fase de OGLE. En la figura (figura pendiente) se puede observar una curva de luz del catálogo de estrellas variables de OGLE-III.    
