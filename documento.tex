...
Como es de esperar, no encontramos que alguna variable sirviera para distinguir todas las clases de variabiliad estelar, sin embargo el vector que forman 
